...
assert.strictEqual(indexSource.includes('id="save-schedule"'), true);
assert.strictEqual(indexSource.includes('Horario de trabajo'), true);
assert.strictEqual(appSource.includes('saveScheduleManually'), true);
